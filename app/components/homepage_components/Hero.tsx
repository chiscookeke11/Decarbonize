...
export default function Hero() {
    return (
        <section className=" w-[90%] md:w-[90%] lg:w-full max-w-7xl rounded-3xl relative min-h-125  overflow-hidden my-18 font-pptelegraph mx-auto ">
            ...
            <div className="w-full h-full absolute top-0 left-0 z-20 py-20 px-6 flex flex-col items-start justify-center gap-4">
                <h1 className=" font-medium text-2xl md:text-5xl lg:text-7xl text-[#e1e4d8] w-[95%] " >Track, Understand, and Reduce Your Digital Carbon Footprint</h1>
                ...
                <div className=" w-full flex flex-col items-start lg:flex-row justify-between lg:items-center gap-10 mt-5 " >
                    ...
                    <p className=" text-lg md:text-xl lg:text-2xl font-medium text-[#e1e4d8] w-[95%]" >
                    ...
                    aria-label="Learn more"
                     className="font-medium flex items-center justify-center gap-1 text-lg md:text-lg shrink-0 "
                      onClick={() => alert("Clicked!")}>Learn More <ChevronRight size={25} /> </Button>
                </div>
            </div>
        </section>
