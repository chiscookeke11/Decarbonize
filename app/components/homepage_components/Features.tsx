...
export default function Features() {
    return (
        <section id="features" className="relative w-[96%] max-w-8xl mx-auto px-6 py-24 text-[#e1e4d8] rounded-xl overflow-hidden my-28 ">
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-6">
                    ...
                    <div className="flex flex-col items-start justify-center min-h-55 md:col-span-3 lg:col-span-6 rounded-3xl p-8 bg-[#E1e4d826] font-pptelegraph backdrop-blur-xs border border-white/10">
                    ...
                    {/* Rewards */}
                    <div className="flex flex-col items-start justify-center min-h-55 md:col-span-2 lg:col-span-3 rounded-3xl p-6 bg-[#E1e4d826] font-pptelegraph backdrop-blur-xs border border-white/10">
                    ...
                    {/* Carbon Offset */}
                    <div className="flex flex-col items-start justify-center min-h-55 md:col-span-2 lg:col-span-6 rounded-3xl p-6 bg-[#E1e4d826] font-pptelegraph backdrop-blur-xs border border-white/10">
                    ...
                    {/* Sustainability Tips */}
                    <div className="flex flex-col items-start justify-center min-h-55 md:col-span-6 lg:col-span-12 rounded-3xl p-8 bg-[#E1e4d826] font-pptelegraph backdrop-blur-xs border border-white/10">
